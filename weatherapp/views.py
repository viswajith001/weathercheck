...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=18b08adbefdb05f45da95012e484833a'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyDbfKb4Z_0LQSyrSmlPUm8yrpaH4bpYHHE'

    SEARCH_ENGINE_ID = 'e27779752ebfd48e6'
